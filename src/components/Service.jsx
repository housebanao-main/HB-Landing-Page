...
import interioricon from "../assets/Interiordesignicon.png";
import lightningicon from "../assets/Lightingdesignicon.png";
import outdooricon from "../assets/Outdoordesignicon.png";
...
const ServicesOffered = () => {
  return (
    <div className="flex flex-col gap-[40px] lg:max-w-[1290px] mx-auto w-full mb-[45px] lg:px-0 px-[20px]">
